...
const WaterLevelChart = () => {
  ...
  const handleDateChange = (event) => {
    ...
    updateFeatureCoordinates(selectedPoint ,selected);
  ...
  <div className="col-md-6 mb-3" >
        <Form.Group>
          <Form.Label style={{ color: colors.greenAccent[400] }}>Select Noeud:</Form.Label>
    ...
    <div className="col-md-6 mb-3" >
        ...
        <Form.Group controlId="datePicker">
          <Form.Label style={{ color: colors.greenAccent[400]}}>Date:</Form.Label>
          <Form.Control
            type="date"
            value={selectedDate}
